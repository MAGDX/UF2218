						...
						<div class="no-overflow">
							<p>
								El lenguaje de expresiones comenzó como una parte de la&nbsp;<a
									...
									title="JavaServer Pages Standard Tag Library">JavaServer
									Pages Standard Tag Library (JSTL)</a>&nbsp;y fue llamado
								originalmente SPEL (Simplest Possible Expression Language), y
								después simplemente&nbsp;<b>Expression Language</b>&nbsp;(EL).
								Era un lenguaje de script que permitía el acceso a los
								componentes de&nbsp;<a
								...
								las etiquetas&nbsp;<a
									href="http://es.wikipedia.org/wiki/JavaServer_Pages"
									title="JavaServer Pages">JSP</a>&nbsp;para separar el código
								Java de JSP, y para permitir un acceso más fácil a los
								componentes de Java (que en código Java).
							</p>
							<p>
								...
								diseñadores de contenido web que tienen poco o prácticamente
								ningún conocimiento del núcleo del lenguaje Java. Este lenguaje
								de script convirtió verdaderamente a JSP en un lenguaje de
								script. Antes de EL, JSP consistía en algunas etiquetas
								especiales como&nbsp;<a
									href="http://es.wikipedia.org/w/index.php?title=Scriptlet&amp;action=edit&amp;redlink=1"
									title="Scriptlet (aún no redactado)">scriptlets</a>,
								expresiones, etc. dentro de las cuales el código Java era
								escrito de forma explícita. Con EL el diseñador de contenido web
								sólo necesita saber cómo hacer las llamadas apropiadas a los
								métodos básicos de Java.
							</p>
							<p>
								EL era, tanto sintáctica como semánticamente, similar a las
								expresiones de&nbsp;<a
									href="http://es.wikipedia.org/wiki/JavaScript"
									title="JavaScript">JavaScript</a>:
							</p>
							<ul>
								<li>no hay conversión de tipos explícita</li>
								<li>las conversiones de tipos se hacen generalmente de
									forma implícita</li>
							...
							<p>
								...
								particularidades de cómo se accede en realidad a los
								valores:&nbsp;
							...
							<p>
								Durante el desarrollo de JSP 2.0, la tecnología&nbsp;<a
									...
									title="JavaServer Faces">JavaServer Faces</a>&nbsp;fue
								publicada, la cual también necesitaba un lenguaje de
								expresiones, pero el lenguaje de expresiones definido en la
								especificación JSP 2.0 no satisfacía todas las necesidades para
								el desarrollo con la tecnología JSF. La limitación más obvia es
								que sus expresiones son evaluadas de inmediato. Y también, los
								componentes de JSF necesitan una manera de invocar métodos de
								objetos del lado del servidor. Un lenguaje más poderoso fue
								creado con las siguientes nuevas características:
							</p>
							<ul>
							...
							<p>El nuevo lenguaje de expresiones funcionó bien para los
								fines de JSF. Pero los desarrolladores tenían problemas en la
								integración de JSP EL con JSF EL debido a conflictos. Debido a
								estas incompatibilidades, la iniciativa "lenguaje de expresión
								unificado" comenzó para unificar estos lenguajes de expresiones.
								A partir de JSP 2.1, los lenguajes de expresión de JSP 2.0 y JSF
								1.1 se han fusionado en un solo lenguaje de expresiones
								unificado (EL 2.1).</p>
							<p>
								<br>
							</p>
							...
							<p>El nuevo EL unificado es una unión de los lenguajes de
								...
								disponibles en el EL de JSP, el EL unificado tiene las
								siguientes características:</p>
							<ul>
								<li>Evaluación diferida</li>
								<li>Soporte para expresiones que pueden establecer valores
									y expresiones que pueden invocar métodos</li>
