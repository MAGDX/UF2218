...
<%@include file="../includes/navbar.jsp"%>
	...
	<hr>
	<h2>Ejemplo GET</h2>
	<p>El método GET solicita una representación del recurso especificado. Las solicitudes que usan GET solo deben recuperar datos y no deben tener ningún otro efecto. (Esto también es cierto para algunos otros métodos HTTP.) Sirven para solicitar datos al servidor.</p>
	...
	<a href="getpost?nombre=Manolo" class="btn btn-outline-primary">Peticion GET</a>
	<br>
	<br>
	...
	<p>Y esto siempre se envia mediante una etiqueta <code>form</code> con el <code>method="post"</code>.</p>
